...
if __name__ == "__main__":
    ...
    config = {
        "data_dir": "data/feta_tab",
        "output_dir": "results/results_feta_tab_bge_colqwen_deepseek", 
    ...
    # Option 1: Use optimized version with multiprocessing
    visdmrag = VisDoMRAG(config)
    visdmrag.run()
